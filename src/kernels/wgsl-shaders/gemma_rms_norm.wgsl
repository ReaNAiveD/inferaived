// Gemma-style RMSNorm: gain is `1 + weight` (centered weights), used by
// this repo's Qwen3.5 checkpoint. The plain-weight variant (Llama / MiniCPM
// `LlamaRMSNorm`) lives in `rms_norm.wgsl`.
struct Params {
